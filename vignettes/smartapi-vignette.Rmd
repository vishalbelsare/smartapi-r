...
gttmodifyRule<-gtt_modify(object,rule_id,"3045","NSE",100000,10,200000,10,365)
gttCancelRule<-gtt_cancel(object,rule_id,"3045","NSE")
gttDetails<-gtt_details(object,rule_id)
...
connection_object<-connect_object(list(feedToken=feedToken,clientCode=clientcode))

webSocket.connect(connection_object,script,task)
