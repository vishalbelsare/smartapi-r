...
order_id<-place_order(object,list(variety="STOPLOSS",tradingsymbol="ITC-EQ",symboltoken="1660",transactiontype="BUY",exchange="NSE",triggerprice="209",ordertype="STOPLOSS_LIMIT",producttype="INTRADAY",duration="DAY",price="210",quantity="323")
OR
order_id<-place_order(object,list(variety="NORMAL",tradingsymbol="SBIN-EQ",symboltoken="3045",transactiontype="BUY",exchange="NSE",ordertype="MARKET",producttype="INTRADAY",duration="DAY",price="210",quantity="323",sqaureoff="0",stoploss="0")
