...
If variety = ROBO than you need to pass stoploss and squareoff value, else pass NULL.
order_id<-place_order(object,"STOPLOSS","ITC-EQ","1660","BUY","NSE","209","STOPLOSS_LIMIT","INTRADAY","DAY","210","323",NULL,NULL)

fOR Variety = Normal than than you need to pass stoploss and squareoff value as NULL.
order_id<-place_order(object,"NORMAL","SBIN-EQ","3045","BUY","NSE",NULL,"LIMIT","INTRADAY","DAY","19500","1",NULL,NULL)

order_id<-modify_order(object,"NORMAL",order_id,"LIMIT","INTRADAY","DAY","19500","1","SBIN-EQ","3045","NSE",NULL,NULL)
